...
class MPCPrimeBrokerClient(object):
    ...
    def create_binding(self, user_id: str):
        ...
        return self.request("POST", "/v1/custody/auth/create_binding/", params)

    def query_binding(self, binder_id: str):
        params = {
            "binder_id": binder_id,
        }
        return self.request("GET", "/v1/custody/auth/query_binding/", params)

    def query_user_auth(self, user_id: str):
        params = {
            "user_id": user_id,
        }
        return self.request("GET", "/v1/custody/auth/query_user_auth/", params)
    ...
    def bind_addresses(self, user_id: str, addresses: str):
        ...
        return self.request("POST", "/v1/custody/auth/bind_addresses/", params)

    def change_binding(self, user_id: str):
        params = {
            "user_id": user_id,
        }
        return self.request("POST", "/v1/custody/auth/change_binding/", params)

    def unbind_binding(self, user_id: str):
        params = {
            "user_id": user_id,
        }
        return self.request("POST", "/v1/custody/auth/unbind_binding/", params)

    def query_statement(self, statement_id: str):
        params = {
            "statement_id": statement_id,
        }
        return self.request("GET", "/v1/custody/auth/query_statement/", params)
